...
- In Practice, open the ⋮ menu and tap "Line review". The screen stays where it is, keeps whatever filter you had (like Cue-to-cue), and marks each trouble word with a soft amber band. While line review is on you can't start a run — the bottom button becomes "Exit line review mode".
- Two floating arrows appear when you have trouble words: the one at the top jumps to the previous line with a marked word, the one at the bottom-right jumps to the next.

## Acting on a word

Tap a marked word for a quick menu:
...
> word's count back down on its own.
